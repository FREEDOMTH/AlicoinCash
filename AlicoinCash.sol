...
contract AlicoinCashToken is owned {
    string public name = "Alicoin Cash";
...
contract AlicoinCashSale is owned {
    
    address public teamWallet = address(0xA304F94F9c2C0b7bb906fCab9B3dd4a84A70bC23);
    ...
    uint public endTime = 1524614400; // 25.04.2018
    uint public tokenPrice = 100 szabo ;

    AlicoinCashToken public tokenReward;
     ...
     * Setup the owner
     */
    function AlicoinCashSale (AlicoinCashToken addressOfTokenUsedAsReward) public {
    ...
    // change crowdsale end time
    function changeEndTime(uint newTime) public onlyOwner {
        endTime = newTime ;
    }
    ...
    function getTokensSoldCount() constant public returns (uint) {
        return tokensSold;
    }
    
    function getAmountRaised() constant public returns (uint) {
        return amountRaised;
    }
    ...
    function buyTokens(address beneficiary) public payable {
        ...
        tokensSold += amount*1000000000000000000/currentPrice() ;
     ...
     */
    function () payable public onlyCrowdsalePeriod {
